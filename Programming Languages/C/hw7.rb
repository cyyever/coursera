...
class Point < GeometryValue
  ...
  private
  def inbetween(x,a,b)
    (a - GeometryExpression::Epsilon <= x && x <= b + GeometryExpression::Epsilon) || (b - GeometryExpression::Epsilon <= x && x <= a + GeometryExpression::Epsilon)
  end
end
...
class LineSegment < GeometryValue
  ...
  def intersectWithSegmentAsLineResult seg
      ...
      then # the segments are on a vertical line
        ...
        then
          Point.new(@x1,a.y2)   #just touching
        elsif a.y2 < b.y1
	then
